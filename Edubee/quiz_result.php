...
<div class="container-fluid">
         ...
         <br><br><br><br><br>
              <h2 class="title_two">Result of Quiz</h2>
              <span></span> 
            </div>
                  <div class="col-sm-9 col-md-6 col-lg-6" style="background-color:white;padding: 15px 50px 15px 50px">
                    <div class="contact_form wow fadeInLeft">
                          ...
                          $count=0;
                           ...
                           ?>
                           <br><br>
                           <?php echo $count." out of ".strlen($result); ?>
                           <br><br><br>
                           <a href="quizes_and_assignments.php">Click Here for another Quiz</a>                        
